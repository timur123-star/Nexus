...
const NAME_TO_ISO: Record<string, string> = {
  // Russia / CIS
  russia: "ru", россия: "ru", ru: "ru", moscow: "ru", москва: "ru", spb: "ru", питер: "ru",
  ukraine: "ua", ua: "ua", kyiv: "ua", kiev: "ua", украина: "ua",
  kazakhstan: "kz", kz: "kz", казахстан: "kz",
  // Europe
  france: "fr", франция: "fr", fr: "fr", paris: "fr", париж: "fr",
  germany: "de", германия: "de", de: "de", frankfurt: "de", франкфурт: "de", berlin: "de",
  netherlands: "nl", nl: "nl", amsterdam: "nl", нидерланды: "nl", голландия: "nl",
  finland: "fi", fi: "fi", helsinki: "fi", финляндия: "fi",
  sweden: "se", se: "se", stockholm: "se", швеция: "se",
  poland: "pl", pl: "pl", warsaw: "pl", польша: "pl",
  uk: "gb", "united kingdom": "gb", london: "gb", gb: "gb", britain: "gb", англия: "gb", лондон: "gb",
  italy: "it", it: "it", milan: "it", италия: "it",
  spain: "es", es: "es", madrid: "es", испания: "es",
  switzerland: "ch", ch: "ch", zurich: "ch", швейцария: "ch",
  austria: "at", at: "at", vienna: "at", австрия: "at",
  norway: "no", no: "no", oslo: "no", норвегия: "no",
  romania: "ro", ro: "ro", bucharest: "ro", румыния: "ro",
  ireland: "ie", ie: "ie", dublin: "ie", ирландия: "ie",
  // Americas
  usa: "us", us: "us", "united states": "us", america: "us", сша: "us", америка: "us",
  canada: "ca", ca: "ca", toronto: "ca", канада: "ca",
  brazil: "br", br: "br", бразилия: "br",
  // Asia / Pacific / ME
  japan: "jp", jp: "jp", tokyo: "jp", япония: "jp", токио: "jp",
  singapore: "sg", sg: "sg", сингапур: "sg",
  hongkong: "hk", hk: "hk", "hong kong": "hk", гонконг: "hk",
  korea: "kr", kr: "kr", seoul: "kr", корея: "kr",
  india: "in", in: "in", mumbai: "in", индия: "in",
  turkey: "tr", tr: "tr", istanbul: "tr", турция: "tr", стамбул: "tr",
  iran: "ir", ir: "ir", tehran: "ir", иран: "ir",
  australia: "au", au: "au", sydney: "au", австралия: "au",
  uae: "ae", ae: "ae", dubai: "ae", дубай: "ae", оаэ: "ae",
...
const TLD_TO_ISO: Record<string, string> = {
  ru: "ru", ua: "ua", kz: "kz", de: "de", fr: "fr", nl: "nl", fi: "fi", se: "se",
  pl: "pl", uk: "gb", it: "it", es: "es", ch: "ch", at: "at", no: "no", ro: "ro",
  ie: "ie", ca: "ca", br: "br", jp: "jp", sg: "sg", hk: "hk", kr: "kr", in: "in",
  tr: "tr", ir: "ir", au: "au", ae: "ae", il: "il", cn: "cn", vn: "vn", us: "us",
};
