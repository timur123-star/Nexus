...
import { Trash2, ArrowDown, ArrowUp, FolderOpen, Clock, Cpu } from "lucide-react";
...
const STATS_STRINGS: Record<
  Lang,
  { session: string; uptime: string; peak: string; avg: string; idle: string }
> = {
  en: { session: "Current session", uptime: "Uptime", peak: "Peak", avg: "Avg", idle: "Not connected" },
  ru: {
  ...
  zh: { session: "\u5f53\u524d\u4f1a\u8bdd", uptime: "\u8fd0\u884c\u65f6\u95f4", peak: "\u5cf0\u503c", avg: "\u5e73\u5747", idle: "\u672a\u8fde\u63a5" },
};
