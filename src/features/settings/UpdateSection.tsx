...
> = {
  en: {
    title: "Updates",
    intro: "Check for new signed releases and install them automatically. Updates are verified with the app's public key before they are applied.",
  ...
  ru: {
    title: "Обновления",
    intro: "Проверяйте новые подписанные релизы и устанавливайте их автоматически. Перед установкой обновление проверяется публичным ключом приложения.",
  ...
  fa: {
    ...
    intro: "نسخه‌های امضاشده جدید را بررسی و به‌طور خودکار نصب کنید. هر به‌روزرسانی پیش از نصب با کلید عمومی برنامه تأیید می‌شود.",
