...
const BACKUP_STRINGS: Record<
  Lang,
  { title: string; intro: string; export: string; import: string; exported: string; imported: string; failed: string }
> = {
  en: {
    title: "Backup & restore",
    intro: "Save all settings, servers and subscriptions to a file, or restore everything from a previously exported file.",
  ...
  ru: {
    ...
    intro: "Сохраните все настройки, серверы и подписки в файл или восстановите всё из ранее сохранённого файла.",
  ...
  fa: {
    ...
    intro: "همه تنظیمات، سرورها و اشتراک‌ها را در یک فایل ذخیره کنید یا از یک فایل قبلی بازیابی کنید.",
