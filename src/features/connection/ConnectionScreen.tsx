      ...
      {items.map((it) => {
        ...
        return (
          ...
          >
            ...
            <Icon size={13} className={cn("relative z-[1]", selected ? "text-indigo" : "text-text-faint")} />
            <span className={cn("relative z-[1]", selected ? "text-text" : "text-text-dim")}>{it.label}</span>
          </button>
        );
      })}
    </div>
