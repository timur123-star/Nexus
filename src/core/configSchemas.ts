  ...
  properties: {
    ...
    dns: {
      ...
      properties: {
        ...
        independent_cache: { type: "boolean", description: "Use an independent DNS cache per server." },
        fakeip: {
          type: "object",
          ...
          properties: {
            ...
            inet4_range: { type: "string", description: "IPv4 fake address range, e.g. 198.18.0.0/15." },
    ...
    inbounds: {
      ...
      items: {
        ...
        properties: {
          ...
          auto_route: { type: "boolean", description: "Automatically configure system routes (TUN)." },
        },
      },
    },
    outbounds: {
      ...
      items: {
        ...
        additionalProperties: true,
        properties: {
          type: { type: "string", description: "Outbound type, e.g. vless, vmess, trojan, shadowsocks, hysteria2, direct, block." },
    ...
    route: {
      ...
      additionalProperties: true,
      properties: {
        rules: { type: "array", description: "Routing rules, evaluated top to bottom.", items: leniencyObject },
        rule_set: { type: "array", description: "External rule-sets (geoip/geosite).", items: leniencyObject },
        final: { type: "string", description: "Tag of the default outbound." },
        auto_detect_interface: { type: "boolean", description: "Auto-detect the default network interface." },
        default_domain_resolver: { type: "string", description: "Default DNS server tag for routing." },
      },
    },
    experimental: {
      type: "object",
      ...
      properties: {
        ...
        clash_api: {
          ...
          properties: {
            external_controller: { type: "string", description: "Controller listen address, e.g. 127.0.0.1:9090." },
...
const xraySchema = {
  ...
  properties: {
    ...
    api: {
      ...
      properties: {
        tag: { type: "string" },
        services: { type: "array", items: { type: "string" }, description: "Enabled API services." },
      },
    },
    dns: { type: "object", description: "DNS configuration.", additionalProperties: true },
    policy: { type: "object", description: "Connection and system policies.", additionalProperties: true },
    stats: { type: "object", description: "Statistics collection (requires the StatsService).", additionalProperties: true },
    inbounds: {
      type: "array",
      ...
      items: {
        ...
        properties: {
          ...
          protocol: { type: "string", description: "Inbound protocol, e.g. socks, http, dokodemo-door." },
    ...
    outbounds: {
      ...
      items: {
        ...
        properties: {
          tag: { type: "string", description: "Unique outbound tag." },
          protocol: { type: "string", description: "Outbound protocol, e.g. vless, vmess, trojan, shadowsocks, freedom, blackhole." },
          settings: leniencyObject,
          streamSettings: leniencyObject,
          mux: leniencyObject,
        },
    ...
    transport: { type: "object", description: "Global transport options.", additionalProperties: true },
  },
} as const;
