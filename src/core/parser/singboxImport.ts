...
function convertOutbound(o: Obj): ServerProfile | null {
  ...
  switch (type) {
    ...
    case "shadowtls": {
      ...
      // SS connection. Modern panels split it: a vless/ss outbound with
      // `detour` pointing at this carrier. We import it standalone so the
      // handshake params aren't lost; the inner SS creds may live on the
      // detouring outbound.
      return {
        ...base(o, "shadowtls"),
        id,
