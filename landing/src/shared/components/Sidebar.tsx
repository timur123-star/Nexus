  ...
  return (
    <div className="relative z-30 w-16 shrink-0">
      <motion.nav
        ...
        style={
          expanded
            ? { background: "color-mix(in srgb, var(--color-bg-elev) 97%, transparent)" }
            : undefined
        }
        className={cn(
      ...
      >
        ...
        <NavButton
          ...
          active={false}
          onClick={() =>
            window.open("https://sing-box.sagernet.org/", "_blank", "noopener,noreferrer")
          }
        />
      </motion.nav>
    </div>
  ...
  return (
    <button
      ...
      className={cn(
        ...
        active ? "bg-indigo/15 text-indigo" : "text-text-dim hover:bg-surface hover:text-text",
      )}
    >
      {active && (
        <motion.span
