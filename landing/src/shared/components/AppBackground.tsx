...
const MAP_STATE = {
  ...
  on: {
    filter: "grayscale(0) brightness(1.08) saturate(1.35) contrast(1.05)",
    opacity: 0.62,
    scale: 1.06,
  },
} as const;
  ...
  return (
    <div aria-hidden className="pointer-events-none fixed inset-0 z-0 overflow-hidden">
      ...
      <motion.img
        ...
        style={{
          maskImage: "linear-gradient(to bottom, #000 0%, #000 66%, transparent 97%)",
          WebkitMaskImage: "linear-gradient(to bottom, #000 0%, #000 66%, transparent 97%)",
        }}
