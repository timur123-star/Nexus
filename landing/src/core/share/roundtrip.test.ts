...
const cases: Case[] = [
  {
    proto: "vless+reality",
    link: "vless://11112222-3333-4444-5555-666677778888@example.com:443?type=tcp&security=reality&pbk=PBK123&sid=SID9&flow=xtls-rprx-vision#R",
  ...
  {
    proto: "vmess",
    link: "vmess://eyJ2IjoiMiIsInBzIjoidm0iLCJhZGQiOiIxLjIuMy40IiwicG9ydCI6IjQ0MyIsImlkIjoiMTExMTIyMjItMzMzMy00NDQ0LTU1NTUtNjY2Njc3Nzc4ODg4IiwiYWlkIjoiMCIsIm5ldCI6IndzIiwidGxzIjoidGxzIn0=",
  ...
  {
    proto: "shadowtls",
    link: "shadowtls://2022-blake3-aes-128-gcm:sspass@1.2.3.4:443?password=hs&version=3&sni=www.microsoft.com#st",
    check: (s) => [s.address, s.port, s.shadowtls?.password, s.shadowtls?.version],
  },
  {
    proto: "wireguard",
    link: "wireguard://cPrivKeyBase64%3D@engage.cloudflareclient.com:2408?publickey=PUBKEY&mtu=1280#WG",
