...
export const killSwitchStatus = () => safeInvoke<boolean>("kill_switch_status", undefined, false);
...
/** Localize the system-tray menu labels to match the UI language. */
export const setTrayLabels = (show: string, toggle: string, quit: string) =>
  safeInvoke<void>("set_tray_labels", { show, toggle, quit }, undefined);
