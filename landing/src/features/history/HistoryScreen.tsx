...
const HISTORY_STRINGS: Record<Lang, Record<string, string>> = {
  en: {
    ...
    clearConfirmBody: "All session history will be permanently deleted.",
    cancel: "Cancel",
  },
  ru: {
    ...
    all: "Все",
    remove: "Удалить",
    clearConfirmTitle: "Очистить всю историю?",
    clearConfirmBody: "Вся история сессий будет удалена безвозвратно.",
    cancel: "Отмена",
  },
  fa: {
    title: "تاریخچه اتصال",
    ...
    all: "همه",
    remove: "حذف",
    clearConfirmTitle: "پاک کردن کل تاریخچه؟",
    clearConfirmBody: "تمام تاریخچهٔ نشست‌ها برای همیشه حذف می‌شود.",
    cancel: "لغو",
  },
  zh: {
    title: "连接历史",
    ...
    all: "全部",
    remove: "删除",
    clearConfirmTitle: "清空全部历史？",
    clearConfirmBody: "所有会话历史将被永久删除。",
    cancel: "取消",
  },
};
...
export function HistoryScreen() {
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-5 p-5">
      ...
      <ConfirmDialog
        open={confirmClear}
        title={hs.clearConfirmTitle}
        body={hs.clearConfirmBody}
        confirmLabel={hs.clearAll}
        cancelLabel={hs.cancel}
        danger
        onConfirm={clear}
      ...
      >
        {ticks.map((_, i) => (
          <span
            ...
            style={{
              transform: `translate(-50%, -50%) rotate(${(360 / ticks.length) * i}deg) translateY(-72px)`,
            }}
          />
        ))}
      </motion.div>
